...
class BlockChain:
	...
	def newProduct(self):
		...
		proHash = hashlib.sha512(str(data).encode()).hexdigest()
	...
	def createBlock(self, data):
		...
		if self.isBlockchainValid():
			...
			preHash = hashlib.sha512(str(preBlock).encode()).hexdigest()
		...
		# currHash = hashlib.sha512(str(transaction).encode()).hexdigest()
		# imgName  = self.imgNameFormatting()
	...
	def isBlockchainValid(self):
		with open("./NODES/N1/blockchain.json", "r") as file:
			n1_hash = hashlib.sha512(str(file.read()).encode()).hexdigest()
			print(n1_hash)
		with open("./NODES/N2/blockchain.json", "r") as file:
			n2_hash = hashlib.sha512(str(file.read()).encode()).hexdigest()
			print(n2_hash)
		with open("./NODES/N3/blockchain.json", "r") as file:
			n3_hash = hashlib.sha512(str(file.read()).encode()).hexdigest()
			print(n3_hash)
		with open("./NODES/N4/blockchain.json", "r") as file:
			n4_hash = hashlib.sha512(str(file.read()).encode()).hexdigest()
			print(n4_hash)
